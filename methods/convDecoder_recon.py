...
class ConvDecoderRecon:
    ...
    def recon(self,gt_datacube,full_datacube,sparse_datacube,
        ...
        # Reinhard Heckel convDecoder NN for accelerate MRI
        # [2,4,8,16,32,64,128,256]
        in_size = [8, 8]  # network input size 8
        num_layers = 6  # number of hidden layers 10 6
        input_channels = 128  # number of input channels 64
        ...
        model = convDecoder.conv_decoder(num_layers, input_channels, num_channels, output_channels,
                                         out_size, in_size).to(self.device)
